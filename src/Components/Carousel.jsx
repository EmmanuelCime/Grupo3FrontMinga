            ...
            <div className="flex items-center md:p-6">
                ...
                <div className="flex flex-col md:flex-row items-center h-[320px] md:h-[340px] w-full">
                    <div className="flex-1">
                        <img src={slides[currentIndex].img} alt={slides[currentIndex].title} className="h-36 xl:h-60 object-contain md:ps-2" />
                    </div>
                    <div className="flex-1 hidden sm:block">
                        <img src={slides[currentIndex].poster} alt={slides[currentIndex].title} className="h-64 lg:h-80 xl:h-96 object-cover mx-auto rounded-lg" />
                    </div>

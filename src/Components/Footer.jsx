...
function Footer() {
    ...
    return (
        <>
            <div>
                <img src={FooterBackground} alt="Manga" />
            </div>
            ...
            <div className="flex justify-around items-center">
                ...
                <div className="w-80">
                    <NavLink to="/home"><img src={MingaLogotype} alt="Minga Logotype" /></NavLink>
                </div>

                <div className="w-80">
                    <div className="flex justify-between">

                        <NavLink to="https://www.facebook.com/"><svg
                            viewBox="0 0 24 24"
                            fill="currentColor"
                            height="2em"
                            width="2em"
                        ...
                        <NavLink to="https://twitter.com/?lang=es"><svg
                        ...
                        <NavLink to="https://vimeo.com/es"><svg
                            viewBox="0 0 24 24"
                            fill="currentColor"
                            height="2em"
                            width="2em"
                        ...
                        <NavLink to="https://www.youtube.com/"><svg
                            viewBox="0 0 24 24"
                            fill="currentColor"
                            height="2em"
                            width="2em"
                    ...
                    <div>
                        <NavLink to="/donate"><img src={DonateButton} alt="Donate" /></NavLink>
                    </div>
                </div>
            </div>
        </>

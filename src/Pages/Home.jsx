    ...
    return (
        <>
            <div className="relative bg-cover bg-center h-screen md:h-screen text-white" style={{ backgroundImage: `url(${backgroundImage})` }}>
                <div className="flex flex-col justify-center items-center sm:items-start h-screen md:h-[700px] p-6 md:p-14">
                    <h1 className="text-2xl sm:text-4xl md:text-6xl lg:text-7xl text-center sm:text-start font-bold">For the love of manga</h1>
                    <p className="mt-4 sm:text-2xl md:text-3xl lg:text-4xl">Explore our varieties and learn about our ia</p>
